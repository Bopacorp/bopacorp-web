...
# ----------------------------------------------------------------------------
# Generated: 2026-05-02T04:31:23.296Z
# Source:    https://ui.shadcn.com/create?template=vite&pointer=true
# ============================================================================

version: alpha
name: "Preset b0"
description: >
  Visual identity is defined by the shadcn preset `b0`. Apply it with
...
preset:
  code:     "b0"
  url:      "https://ui.shadcn.com/create?template=vite&pointer=true"
  apply:    "npx shadcn@latest apply b0"
  init:     "npx shadcn@latest init --preset b0 --template next"
...
shadcn preset `b0`. **Apply the preset; do not redefine its tokens
inside this file.**

```bash
npx shadcn@latest apply b0
```
...
- Apply the preset (`npx shadcn@latest apply b0`) instead of pasting color values.
...
`pnpm dlx shadcn@latest apply b0` writes into `globals.css`.
...
Full `decodePreset(b0)` output plus the resolved OKLCH variables.
...
{
  "code": null,
  "sourceUrl": "https://ui.shadcn.com/create?template=vite&pointer=true",
  "generatedAt": "2026-05-02T04:31:23.296Z",
  "install": null,
  "decoded": null,
  "resolved": {
    "style": null,
