...
**Estado de Fase 6:** estados transversales, accesibilidad observable, navegación, teclado, idioma y tema ejecutados en Vitest; responsive/visual queda como revisión manual `Not run`. Se conserva la evidencia de Fases 1–5.
