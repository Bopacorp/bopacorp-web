          ...
          <div className="flex flex-col items-center gap-6 max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-2">
              <Button
                asChild
                size="lg"
                className="rounded-md font-medium transition-colors bg-[#008be2] text-white hover:bg-[#008be2]/90 border-none cursor-pointer"
              >
                <Link to="/services">
      ...
      <section className="w-full text-white relative overflow-hidden py-24 px-6 bg-gradient-to-r from-[#06152b] via-[#0a2246] to-[#008be2]">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-8 relative z-10">
          ...
          <h2 className="text-3xl font-semibold tracking-tight text-white sm:text-5xl md:text-6xl leading-tight">
            ...
            <span className="text-[#008be2]">conectividad real</span>
          </h2>
